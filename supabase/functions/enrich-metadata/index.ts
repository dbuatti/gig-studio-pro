...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`[AI Engine] Processing ${mode} for ${queries?.length || 0} items`);
    ...
    // Using gemini-1.5-flash-latest on v1beta - this is the most compatible free tier endpoint
    ...
    console.log("[AI Engine] Parsing response text...");
