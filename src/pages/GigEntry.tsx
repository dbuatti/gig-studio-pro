      ...
      <div className="max-w-md w-full space-y-12 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 font-medium tracking-tight">Enter your specific gig code to view tonight's setlist.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleJoin} className="space-y-4">
          <div className="relative group">
            <Input 
              ...
              className="h-20 bg-white/5 border-white/10 rounded-3xl text-center text-3xl font-black uppercase tracking-[0.2em] focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all"
            />
