...
export const RESOURCE_TYPES = [
  ...
  { id: 'WEB', label: 'Web Sheet', color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
  { id: 'PDF', label: 'Stage PDF', color: 'bg-emerald-500/10 text-emerald-600 border-emerald-200' },
