  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="p-6 space-y-6 pb-24 md:pb-6 bg-background">
        ...
        {file && (
          <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300 border-t pt-6 border-border">
            <div className="flex flex-col items-center gap-5">
              {activeVideoId && (
                <div className="w-full aspect-video rounded-xl overflow-hidden shadow-lg border border-border bg-background">
            ...
            <div className="bg-card p-5 rounded-2xl border border-border space-y-4">
              <div className="flex items-center justify-between border-b pb-2 mb-2 border-border">
            ...
            <div className="grid grid-cols-1 gap-6 bg-card p-5 rounded-2xl border border-border">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button onClick={() => handleOctaveShift('down')} className="h-7 px-2 hover:bg-accent rounded text-[10px] font-black uppercase text-muted-foreground hover:text-primary transition-colors border-r border-border">- oct</button>
                          </TooltipTrigger>
              ...
              <div className="grid grid-cols-2 gap-6 pt-4 border-t border-border">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1.5"><Volume2 className="w-3 h-3" /> Gain</Label>
