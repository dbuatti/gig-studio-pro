      ...
      <DialogContent className="max-w-4xl bg-slate-950 border-white/10 text-white rounded-[2.5rem] p-0 overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar bg-slate-950">
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between px-2">
              ...
              <span className="text-[10px] font-mono text-slate-600 uppercase">{repertoire.length} Total Records</span>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-[2rem] space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-black font-mono text-emerald-400">{stats.r2}</span>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Cloudflare R2</p>
                    <Progress value={stats.r2Percent} className="h-1.5 mt-3 bg-emerald-900" />
                  </div>
                </div>
                ...
                <div className="p-6 bg-amber-500/5 border border-amber-500/10 rounded-[2rem] space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-black font-mono text-amber-400">{stats.supabaseLegacy}</span>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Legacy Supabase</p>
                    <Progress value={stats.supabasePercent} className="h-1.5 mt-3 bg-amber-900" />
                  </div>
                </div>
                ...
                <div className="p-6 bg-indigo-500/5 border border-indigo-500/10 rounded-[2rem] space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-black font-mono text-indigo-400">{stats.itunes}</span>
                  </div>
                  <div>
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">iTunes Previews</p>
                    <Progress value={stats.itunesPercent} className="h-1.5 mt-3 bg-indigo-900" />
                  </div>
                </div>
              </div>
            )}
            ...
            {stats?.supabaseLegacy === 0 && (
              <div className="flex items-center gap-4 p-5 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl mx-2">
                <CheckCircle2 className="w-6 h-6 text-emerald-500" />
                <p className="text-xs font-black uppercase tracking-widest text-emerald-400">All legacy files have been successfully migrated to R2.</p>
              </div>
            )}
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-sm font-black uppercase tracking-widest text-white">Automation & Migration</h3>
              </div>
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full justify-start gap-4 h-16 rounded-2xl border-white/10 bg-black/20 hover:bg-indigo-600/10 hover:text-indigo-400 transition-all"
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[9px] font-bold uppercase opacity-40">Move {stats?.supabaseLegacy} legacy files to R2</p>
                  </div>
                </Button>
                ...
                <Button
                  ...
                  disabled={isRenaming}
                  className="w-full justify-start gap-4 h-16 rounded-2xl border-white/10 bg-black/20 hover:bg-amber-600/10 hover:text-amber-400 transition-all"
                >
            ...
            <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-sm font-black uppercase tracking-widest text-white">Maintenance</h3>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[9px] font-bold uppercase opacity-40">Removes duplicates from every gig</p>
                  </div>
                </Button>
                ...
                <Button
                  ...
                  className="w-full justify-start gap-4 h-16 rounded-2xl border-white/10 bg-black/20 hover:bg-white/10 transition-all"
                >
                  <RefreshCw className="w-5 h-5" />
                  <div className="text-left">
                    <p className="text-xs font-black uppercase tracking-tight">Force Refresh</p>
                    <p className="text-[9px] font-bold uppercase opacity-40">Reload all repertoire data</p>
                  </div>
                </Button>
              </div>
            </div>
        ...
        <div className="p-8 bg-slate-900 border-t border-white/5 flex justify-between items-center shrink-0">
          <Button
            ...
            className="text-red-400 hover:text-red-300 hover:bg-red-400/10 font-black uppercase text-[10px] tracking-widest h-12 px-6 rounded-xl"
          >
