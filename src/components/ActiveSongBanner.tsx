...
const ActiveSongBanner: React.FC<ActiveSongBannerProps> = ({ 
  ...
  return (
    <div className="sticky top-0 z-20 mb-6 animate-in slide-in-from-top duration-500">
      <div className="bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl overflow-hidden border-4 border-indigo-600/20">
          ...
          <div className="flex items-center gap-10 shrink-0">
            <div className="flex gap-8 border-l border-white/5 pl-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xl font-black text-white font-mono">{(song.pitch || 0) > 0 ? '+' : ''}{song.pitch || 0} <span className="text-[10px] text-slate-500">ST</span></span>
              </div>
            </div>
