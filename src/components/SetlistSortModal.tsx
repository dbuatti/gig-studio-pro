                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button 
                          ...
                          className="h-[34px] px-2 bg-white/5 border-l border-white/10 rounded-r-lg text-indigo-400 hover:bg-white/10 transition-colors"
                        >
                          <Info className="w-3 h-3" />
                        </button>
                      </TooltipTrigger>
                      <TooltipContent side="bottom" className="max-w-xs p-3 bg-slate-900 border-white/10 text-[10px] font-medium leading-relaxed">
                        <div className="flex flex-col gap-2">
                          <p>{preset.instruction}</p>
                          <div className="flex items-center gap-1 text-indigo-400 font-black uppercase text-[8px]">
                            <Copy className="w-2.5 h-2.5" /> Click icon to copy prompt
                          </div>
                        </div>
                      </TooltipContent>
                    </Tooltip>
